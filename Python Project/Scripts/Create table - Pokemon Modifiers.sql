...
CREATE TABLE Pokemon_NatureAndModifiers
(
    Nature NVARCHAR(50) NOT NULL,
    Raise NVARCHAR(50) NOT NULL,
    Lower NVARCHAR(50) NOT NULL,
    LikedFlavor NVARCHAR(50) NOT NULL,
    DislikedFlavor NVARCHAR(50) NOT NULL,
    HP INT NOT NULL,
    ATK INT NOT NULL,
    DEF INT NOT NULL,
    SATK INT NOT NULL,
...
ALTER TABLE Pokemon..Pokemon_NatureAndModifiers 
